...
<div class="max-w-lg mx-auto">
    <h1 class="text-2xl font-bold text-gray-800 mb-6">Nouveau fournisseur</h1>

    <form action="{{ route('fournisseurs.store') }}" method="POST" class="bg-white shadow rounded p-6 space-y-4">
        @csrf

        <div>
            <label class="block text-sm font-medium text-gray-700">Raison sociale</label>
            <input type="text" name="raison_sociale" value="{{ old('raison_sociale') }}" maxlength="255"
        ...
        <div>
            ...
            <input type="text" name="telephone" value="{{ old('telephone') }}" maxlength="20"
