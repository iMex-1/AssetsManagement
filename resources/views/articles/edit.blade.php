...
<div class="max-w-lg mx-auto">
    ...
    <form action="{{ route('articles.update', $article) }}" method="POST" class="bg-white shadow rounded p-6 space-y-4">
        @csrf
        @method('PUT')
        ...
        <div>
            ...
            <select name="categorie"
                ...
                <option value="Fourniture" {{ old('categorie', $article->categorie) === 'Fourniture' ? 'selected' : '' }}>Fourniture</option>
            </select>
            @error('categorie')
                <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
            @enderror
        ...
        <div>
            ...
            <input type="number" name="stock_actuel" value="{{ old('stock_actuel', $article->stock_actuel) }}" min="0"
        ...
        <div>
            ...
            <input type="number" name="seuil_alerte" value="{{ old('seuil_alerte', $article->seuil_alerte) }}" min="0"
